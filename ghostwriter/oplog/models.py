...
class OplogEntry(models.Model):
    ...
    # Vanguard: ATT&CK tagging (PRD 5.4/5.5)
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=["technique_id"], name="oplog_entry_technique_idx"),
            models.Index(fields=["tactic"], name="oplog_entry_tactic_idx"),
        ]
