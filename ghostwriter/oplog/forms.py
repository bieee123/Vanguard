...
class OplogEntryForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Row(
                Column("technique_id", css_class="form-group col-3 mb-0"),
                Column("tactic", css_class="form-group col-3 mb-0"),
                Column("outcome", css_class="form-group col-3 mb-0"),
                Column("sequence_order", css_class="form-group col-3 mb-0"),
                css_class="form-row",
            ),
            "asset",
            "tags",
